magic_array = [
    ...
    [b'\x00\x00\x01\xBA', 0, ['.mpg', '.mpeg', '.vob'], 'video/dvd', 'DVD video file'],
    ### Audio ###
    ...
    [b'\x4D\x54\x68\x64', 0, ['.midi', '.mid'], 'audio/x-midi', 'Musical Instrument Digital Interface sound file'],
    ...
    [b'\x46\x4F\x52\x4D\x00', 0, '.aif', 'audio/x-aiff', 'Audio Interchange File'],
    ...
    [b'\x49\x20\x49', 0, ['.tif', '.tiff'], 'image/tiff', 'Tagged Image File Format file'],
    [b'\x49\x49\x2A\x00', 0, ['.tif', '.tiff'], 'image/tiff', 'Tagged Image File Format file (Intel)'],
    [b'\x4D\x4D\x00\x2A', 0, ['.tif', '.tiff'], 'image/tiff', 'Tagged Image File Format file (Motorola)'],
    [b'\x4D\x4D\x00\x2B', 0, ['.tif', '.tiff'], 'image/tiff', 'BigTIFF files, Tagged Image File Format file larger than 4 GB'],
    [b'\x89\x50\x4E\x47\x0D\x0A\x1A\x0A', 0, '.png', 'image/png', 'Portable Network Graphics file'],
    [b'\xFF\xD8\xFF', 0, ['.jpg', '.jpeg'], 'image/jpeg', 'JPEG/JFIF graphics file'],
    [b'\x67\x69\x6d\x70\x20\x78\x63\x66\x20', 0, '.xcf', 'image/x-xcf', 'XCF Gimp Image file'],
    ### office ###
    [b'\x50\x4B\x03\x04\x14\x00\x06\x00', 0, ['.docx', '.pptx', 'xlsx'], 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'Microsoft Office 2007+ Open XML Format Document file'],
    ...
    [b'\x1F\x9D', 0, ['.tar.gz', '.tgz'], 'application/x-tgz', 'Compressed tape archive file using standard compression'],
    [b'\x1F\xA0', 0, ['.tar.gz', '.tgz'], 'application/x-tgz', 'Compressed tape archive file using LZH compression'],
    ...
    [b'\x42\x5A\x68', 0, ['.bz2', '.bzip2'], 'application/x-bzip2', 'BZIP2 Compressed Archive file'],
